...
function [optmParameter, modelparameter] =  initialization
    %% ours
    optmParameter.lambda1   = 2^-3; %  missing feature
    optmParameter.lambda2   = 2^-3;  %  feature correlation
    optmParameter.lambda3   = 2^-1;  %  label correlation 
    optmParameter.lambda4   = 2^-6; %  sparsity
    ...
    optmParameter.minimumLossMargin = 0.0005; %£¨oldloss - totalloss)/oldloss
